...
| ---------------------------------- | -------------------------------------------------------------------------------------------------- |
| `Abenteuer, Dungeons & Minispiele` | fertige oder halbfertige One-Shots, Mini-Kampagnen und Story-Ideen, Dungeons und Minispiele        |
...
Alles in diesem Repository steht unter  
**[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.de)**  
(Namensnennung – Nicht kommerziell – Weitergabe unter gleichen Bedingungen)

Kurz gesagt:  
Du darfst alles nehmen, verändern, in deiner Runde spielen, weitergeben – solange du  
- mich (Pascal) nennst,  
- es nicht verkaufst,  
- deine Version wieder unter CC BY-NC-SA stellst.

## Mitmachen / Feedback

Falls du etwas findest, das  
- komplett kaputt ist  
- unfassbar cool/unfair/spaßig ist  
- du stark verbessern könntest  

→ gerne Issue eröffnen oder Pull Request schicken.  
Ich freue mich über jedes Feedback, besonders von Leuten, die es wirklich am Tisch getestet haben!

---

Viel Spaß beim Spielen und beim Durchstöbern!  
Möge dein Würfelbecher niemals leer sein. 🎲

– Pascal, irgendwann im Jahr 2025